                ...
                try
                {
                    ...
                    if (raw_text[0] == "LOGIN")
                    {
                        ...
                        else
                        {
                            ...
                            if (!username.All(char.IsLetterOrDigit) || username.Length < 4 ||  username.Length > 512) { success = false; }
                            else
                            {
                    ...
                    else if (raw_text[0] == "REGISTER")
                    {
                        ...
                        else
                        {
                            ...
                            if (!username.All(char.IsLetterOrDigit) || username.Length < 5  || username.Length > 512) { success = false; }
                            else
                            {
